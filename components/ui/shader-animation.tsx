...
/**
 * Ambient plasma-line shader, rendered into its container (not the viewport) so it can be used
 * as a contained background layer — e.g. behind a CTA section — rather than a full-page effect.
 */
